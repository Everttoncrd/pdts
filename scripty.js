...
async function buscarImagem(cidade) {
  const url = `https://api.unsplash.com/photos/random?query=${cidade}&orientation=landscape&client_id=${accessKey}&fit=crop&w=1920&h=1080`;
